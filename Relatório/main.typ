...
Estando já familiarizado com o mercado de leilões relacionados a música, tradicionais e online, e possuindo ele próprio uma extensa de coleção de vinis --- maioritariamente jazz --- encarou esta decisão como uma oportunidade para juntar duas das suas áreas de interesse e para voltar à vida profissional, que tivera anos atrás, com entusiasmo. Além disso, reconheceu e concluiu que um leilão online traria muitas vantagens em relação a um tradicional.
...
Como a ideia visiona um leilão online, inúmeras vantagens provêm desse facto: os custos de transação para os compradores e vendedores diminuem, podem ser aceites diversos métodos de pagamento, podem existir leilões de duração ininterrupta, a exibição e descrição detalhada de produtos tornou-se simples e facilmente acessível, uma plataforma digital facilita a realização de leilões complexos e simultâneos, e amplia a participação, sendo que a localização geográfica dos participantes deixa de ser um obstáculo --- uma grande mudança em relação aos leilões tradicionais.
...
Por fim, como a maioria dos clientes prefere métodos justos e honestos, será adotado um tipo de leilão que na teoria possui essas características, e este será customizado para se alinhar com o ambiente digital. Assim, não será utilizado, por exemplo, o “english auction”, mas sim um “ascending clock auction”, também chamado de leilão japonês (mas um pouco modificado, tal como foi mencionado).
...
Ou seja, o preço aumenta continuamente, talvez por intervalos de tempo, a partir de um preço inicial, e os participantes podem escolher sair. Esta ideia, apesar de tradicional, adequa-se ao ambiente digital pois o processo é muito mais simples do que, por exemplo, o "ascending-bid auction" normal, possuindo ainda assim características de um "general model" #footnote("Também existem outros tipos básicos como a \"descending-bid\", \"first-price sealed-bid\", e \"second-price sealed-bid\". Em teoria, mas tendo mais em consideração um \"private-value model\", a \"descending-bid\" é basicamente uma \"first-price sealed-bid\" em termos de \"outcome\", sendo por vezes chamada de \"open first-price auction\". Da mesma forma, a \"ascending-bid\" (versão japonesa) é semelhante a uma \"second-price auction\", como se prova com o teorema da \"revenue equivalence\"."). Também serão utilizados alguns aspetos da "second-price sealed-bid" de uma forma semelhante ao leilão "Anglo-Dutch", que consegue capturar as vantagens do "sealed-bid auction" @auction_design_article.
